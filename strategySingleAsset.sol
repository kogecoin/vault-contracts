...
abstract contract StrategySingleBase is BaseStrategyMasterChef {
    ...
    address public constant usdc = rewardToken;
    ...
    {
        usdc_titan_path = new address[](3);
        usdc_titan_path[0] = usdc;
        usdc_titan_path[1] = iron;
        usdc_titan_path[2] = titan;
    }
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            if (rewardToken != want) {
                _swapUniswapWithPath(usdc_titan_path, _harvestBalance);
            }
